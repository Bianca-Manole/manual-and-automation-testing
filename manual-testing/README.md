...
This section contains all manual testing artifacts produced during the QA course.
...
- **Contact List App** — requirements analysis and test case design
- **Parking App** — Valet Parking and Long Term Garage Parking features
- **E-Commerce Web App** — Login, Inventory, Cart, Checkout, Order Summary, Logout features
